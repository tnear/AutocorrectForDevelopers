...
#HotIf !WinActive('ahk_exe WINWORD.exe')
    ...
    ::cgropus::cgroups              ; linux control groups
    ::cahining::chaining
    ::chaingn::chaining
    ::chianing::chaining
    ::chians::chains
    ...
    ::onlly::only
    ::opesn::opens
    :*:oeprat::operat               ; operat/ed/es/ion/ional
    :*:opereat::operate
    ...
    ::prioirty::priority
    ::privte::private
    :*:privelege::privilege         ; privilege/d/s
    ...
    :*:whle(::while(
    :*:whtie::white                 ; white/list/board/space
    :*:hwite::white
