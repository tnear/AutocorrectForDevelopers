...
; note: AHK v1 and Espanso are also supported, see https://github.com/tnear/AutocorrectForDevelopers
...
#HotIf !WinActive('ahk_exe WINWORD.exe')
    ...
    :b0:geld::         ; do not convert this string to -gled
    ...
    ::alot::a lot
    :*:abbrevait::abbreviat         ; abbreviat/es/ed/ion
    ::abl eto::able to
    ::able ot::able to
    ::albe to::able to
    ::abotu::about
    ...
    ::guaged::gauged
    ::guages::gauges
    :*:gneer::gener                 ; gener/ic/al/ate/ates/ator
    ...
    ::ilsts::lists
    ::lvie::live
    :*:lcoal::local                 ; local/ly/ize/ity/ization
    ::lcoation::location
    ::lcoations::locations
    ::logairthm::logarithm
    ::lgoical::logical
    ...
    ::moveis::movies
    ::muhc::much
    :*:mjulti::multi                ; multi/threaded/plex/process/tasking/ply
    ...
    ::spawsn::spawns
    ::speical::special
    :*:speicfi::specifi             ; specifi/c/ed/ly/ier/iers
    :*:speicif::specifi
    ...
    :*:uspport::support
    :*:supperss::suppress           ; suppress/ed/es/ion/ing
    ...
    ::unorderd::unordered
    ::unordrerd::unordered
    ::unorderd_map::unordered_map   ; C++ container
    ...
    :*:whle(::while(
    :*:whtie::white                 ; white/board/list/space
    :*:hwite::white
    ...
    :C?:gnig::ging
    :C?:geld::gled        ; ex: toggled, mangled, tangled, singled, struggled, juggled
    ...
    :C?:laod::load        ; ex: load, overload, download, upload, workload, offload, bootload
    :C?:laoded::loaded
    :C?:laoder::loader
    :C?:laoding::loading
    :C?:laods::loads
    ...
    :C?:sitcs::stics
    :C?:stisc::stics
    :C?:tsing::sting      ; ex: testing, nesting, hosting, persisting, broadcasting, posting, requesting
    ...
    :C?:wnigs::wings
    :C?:wgins::wings
    :C?:owrk::work        ; ex: work, network, framework, rework, coursework, groundwork, patchwork, guesswork
    :C?:wokr::work
    :C?:wrok::work
    :C?:owrking::working
    :C?:wokring::working
