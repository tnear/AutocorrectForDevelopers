...
#HotIf !WinActive('ahk_exe WINWORD.exe')
    ...
    :*:refacotr::refactor
    :*:refernce::reference          ; reference/d/r/s
    :*:refrence::reference
    ::referal::referral
    ::referals::referrals
    ::refersh::refresh
    ...
    :C?:albe::able        ; ex: available, mutable, scalable, readable, variable, testable, portable
