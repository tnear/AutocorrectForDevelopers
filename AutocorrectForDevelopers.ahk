...
; AUTOCORRECT SCRIPT
; Exclude MS Word because it already has autocorrect
; (although it is missing many programming words).
...
#HotIf !WinActive('ahk_exe WINWORD.exe')
    ...
    :b0:awrd::         ; do not convert this string to -ward
    :b0:awrded::       ; do not convert this string to -warded
    :b0:awrding::      ; do not convert this string to -warding
    :b0:awrds::        ; do not convert this string to -wards
    ...
    :b0:cetn::         ; do not convert this string to -cent
    ...
    :b0:cning::        ; do not convert this string to -ncing
    :b0:cotr::         ; do not convert this string to -ctor
    :b0:cotrs::        ; do not convert this string to -ctors
    ...
    :b0:dnable::       ; do not convert this string to -ndable
    ...
    :b0:hgter::        ; do not convert this string to -ghter
    ...
    :b0:hpic::         ; do not convert this string to -phic
    ...
    :b0:ilze::         ; do not convert this string to -lize
    :b0:ilzed::        ; do not convert this string to -lized
    :b0:ilzer::        ; do not convert this string to -lizer
    ...
    :b0:ionted::       ; do not convert this string to -ointed
    ...
    :b0:isign::        ; do not convert this string to -ising
    ...
    :b0:oatr::         ; do not convert this string to -ator
    :b0:oatrs::        ; do not convert this string to -ators
    ...
    :b0:oguh::         ; do not convert this string to -ough
    ...
    :b0:onited::       ; do not convert this string to -ointed
    ...
    :b0:ouhg::         ; do not convert this string to -ough
    ...
    :b0:setn::         ; do not convert this string to -sent
    ...
    :b0:teyl::         ; do not convert this string to -tely
    ...
    :b0:ualte::        ; do not convert this string to -ulate
    :b0:ualted::       ; do not convert this string to -ulated
    :b0:ualtes::       ; do not convert this string to -ulates
    :b0:uerd::         ; do not convert this string to -ured
    :b0:ugth::         ; do not convert this string to -ught
    :b0:ullly::        ; do not convert this string to -ully
    :b0:ulyl::         ; do not convert this string to -ully
    :b0:uogh::         ; do not convert this string to -ough
    ...
    :b0:wrading::      ; do not convert this string to -warding
    ...
    ::accessign::accessing
    ::accesing::accessing
    ::accidenetally::accidentally
    :*:accomodat::accommodat        ; accommodat/e/ed/es/ing
    ::accomplihs::accomplish
    ::according ot::according to
    :C*:acount::account             ; account/s/ed/ing/able. Case sensitive to avoid matches like 'aCounter'
    ...
    ::bolean::boolean
    ::boolena::boolean
    :*:bootstarp::bootstrap         ; bootstrap/s/ped/ping
    ...
    ::consoel::console
    ::conosle::console
    ::cosnt::const                  ; C++ keyword
    ::conts::const
    ::ocnst::const
    ::csont::const
    :*:cosntant::constant           ; constant/s/ly
    :*:contsant::constant
    :*:ocnstant::constant
    :*:csontant::constant
    ...
    ::ocnstexpr::constexpr
    ::csontexpr::constexpr
    :*:cosntr::constr               ; constr/ain/uct/aint/uctor
    :*:contsr::constr
    :*:ocnstr::constr
    :*:csontr::constr
    ::constrian::constrain
    ...
    :*:corupt::corrupt              ; corrupt/s/ed/ing
    ::coudl::could
    ::oculd::could
    ::could nto::could not
    ::could ont::could not
    ...
    ::dataests::datasets
    ::dtaasets::datasets
    :*:daedlock::deadlock           ; deadlock/s/ed/ing
    ...
    :*:decyrpt::decrypt             ; decrypt/s/ed/ing
    :*:decrytp::decrypt
    ...
    :*:diminsih::diminish           ; diminish/ed/es/ing
    ...
    :*:disacrd::discard             ; discard/s/ed/ing
    :*:disconenct::disconnect       ; disconnect/ed/ion/ing/ions/or
    :*:disconect::disconnect
    :*:idsconnect::disconnect
    :*:disocnnect::disconnect
    :*:disocver::discover           ; discover/s/y/ed/ing
    :*:disucss::discuss             ; discuss/ed/ing/ion
    ...
    ::enbales::enables
    ::eanbles::enables
    :*:encapuslat::encapsulat       ; encapsulat/e/ed/ing/ion
    ::encalve::enclave
    ::encodres::encoders
    :*:encoutner::encounter         ; encounter/s/ed/ing
    :*:encyrpt::encrypt             ; encrypt/s/ed/ion
    :*:encrytp::encrypt
    ...
    ::endores::endorse
    ::endorsign::endorsing
    :*:enfroc::enforc               ; enforc/e/ed/ing/ement
    ::engaeg::engage
    ::egnine::engine
    ::engien::engine
    ::enginer::engineer
    ...
    ::fuction::function
    ::fuctnion::function
    :*:functioal::functional        ; functional/ity/ities
    :*:fucntional::functional
    :*:funtional::functional
    :*:fnctional::functional
    :*:fucniotnal::functional
    :*:funtcional::functional
    :*:fuctional::functional
    :*:fuctnional::functional
    ::fucnitonality::functionality
    ::fucntinoality::functionality
    ::fucntoinality::functionality
    ::funcitonality::functionality
    ::functoining::functioning
    ::fucntioning::functioning
    ::funtioning::functioning
    ::fnctioning::functioning
    ::fucnitoning::functioning
    ::fucntinoing::functioning
    ::fucntoining::functioning
    ::fucniotning::functioning
    ::funtcioning::functioning
    ::fuctioning::functioning
    ::fuctnioning::functioning
    ...
    ::generaetions::generations
    ::generaetor::generator
    ::generaetors::generators
    ::getenfroce::getenforce        ; linux command
    ::githbu::github
    ::gvie::give
    ::gvien::given
    ::givne::given
    ...
    ::hadnling::handling
    ::hanlding::handling
    :*:handhsak::handshak           ; handshak/e/es/ing
    :C:hagn::hang
    ::hagning::hanging
    ::hagns::hangs
    ::hapen::happen
    ...
    ::highets::highest
    ::hgihest::highest
    :*:hihglight::highlight         ; highlight/s/ed/ing
    ::histroy::history
    ::hodler::holder
    ::hodlers::holders
    ::hodling::holding
    ...
    ::hudnred::hundred
    ::hudnreds::hundreds
    :*:hyepr::hyper                   ; hyper/link/text/visor/parameter
    ...
    ::inefficinet::inefficient
    ::ineficiently::inefficiently
    ::inefficently::inefficiently
    ::inefficinetly::inefficiently
    :*:inifnit::infinit             ; infinit/e/y/ely
    :*:infalt::inflat               ; inflat/e/es/ing/ion
    :C:inof::info
    :C:ifno::info
    :*:infomr::inform               ; inform/s/ed/ation/ative
    :*:inofrmati::informati         ; informati/on/ve/onal
    :*:ifnormati::informati
    ...
    :*:lcoat::locat                 ; locat/e/ed/er/es/ion
    ::logairthm::logarithm
    ::lgoical::logical
    ::loign::login
    ::logpiotn::logpoint
    ...
    ::materila::material
    ::materilas::materials
    :*:mathmatic::mathematic        ; mathematic/s/al/ian
    ::maltab::matlab
    ::mtalab::matlab
    ::amtrix::matrix
    ::maxiaml::maximal
    ...
    :*:misconifgur::misconfigur     ; misconfigur/e/ed/es/ing
    ::mismtach::mismatch
    ::misraed::misread
    ::mising::missing
    ::missign::missing
    ...
    :*:multithraed::multithread     ; multithread/ed/ing
    ...
    ::nmaespaces::namespaces
    ::namepaces::namespaces
    ::naemspaces::namespaces
    ::naturla::natural
    :C:naer::near
    ::naerby::nearby
    ::neraby::nearby
    ...
    ::ondes::nodes
    ::ndoes::nodes
    ::nodisacrd::nodiscard          ; C++ attribute
    ::nosiy::noisy
    ...
    :*:overflwo::overflow
    ::overhaed::overhead
    :*:overhaet::overheat           ; overheat/s/ed
    ::overalp::overlap
    ::overiden::overridden
    ...
    ::oplicy::policy
    ::oplling::polling
    :*:polymorhp::polymorph         ; polymorph/ic/ism
    ...
    :*:reconifgur::reconfigur       ; reconfigur/e/ed/es/ing
    ...
    ::releasign::releasing
    ::relevnat::relevant
    :*:reloact::relocat             ; relocat/e/ed/es/ing/ion
    :*:relcoat::relocat
    ...
    ::serila::serial
    :*:esrial::serial               ; serial/ise/ize/izer/izable
    ::serliase::serialise
    ...
    ::sersvices::services
    ::servcies::services
    ::setenfroce::setenforce        ; linux command
    ...
    ::stmap::stamp
    ::stnad::stand
    :*:stnadard::standard           ; standard/s/ise/ize
    :*:standrad::standard
    ::stnading::standing
    ::stnads::stands
    ::stnadup::standup
    ...
    ::unintuivie::unintuitive
    ::unintiutive::unintuitive
    ::unintutively::unintuitively
    ::unintuiviely::unintuitively
    ::unintiutively::unintuitively
    ::unoin::union
    ...
    ::hwenever::whenever
    :C:WHere::Where
    :C:Wheer::Where                 ; suffix rule for '-wheer' is case sensitive
    ::whree::where
    ::werhe::where
    ::wher eare::where are
    ::wher ethe::where the
    ...
    ::owrkarounds::workarounds
    ::wokrarounds::workarounds
    ::owrked::worked
    ::wokred::worked
    ::wroked::worked
    ::worekd::worked
    ...
    :C?:taively::atively
    :C?:aitvely::atively
    :C?:atro::ator        ; ex: generator, emulator, operator, iterator, numerator, administrator, decorator
    :C?:aotr::ator
    :C?:oatr::ator
    :C?:atros::ators
    :C?:aotrs::ators
    ...
    :C?:caions::cations
    :C?:catsions::cations
    :C?:cetn::cent        ; ex: adjacent, recent, ascent, nascent, percent, quiescent
    ...
    :C?:ofrm::form        ; ex: platform, perform, transform, inform, uniform, conform, terraform
    :C?:fomr::form
    :C?:ofmr::form
    :C?:ofrmed::formed
    :C?:fomred::formed
    ...
    :C?:getnly::gently
    :C?:hgter::ghter      ; ex: brighter, highlighter, lighter, straighter, tighter, fighter
    ...
    :C?:isign::ising      ; ex: advising, arising, promising, raising, revising, rising
    ...
    :C?:cning::ncing
    :C?:dnable::ndable    ; ex: appendable, dependable, expandable, extendable, findable, bindable
    ...
    :C?:oitn::oint        ; ex: powerpoint, breakpoint, disjoint, watchpoint, checkpoint, midpoint, appoint
    :C?:iont::oint
    :C?:onit::oint
    :C?:onited::ointed
    :C?:ionted::ointed
    ...
    :C?:ouhg::ough        ; ex: although, breakthrough, enough, fallthrough, though, through, walkthrough
    :C?:oguh::ough
    :C?:uogh::ough
    ...
    :C?:hpic::phic        ; ex: graphic, cryptographic, polymorphic, catastrophic, isomorphic, lexicographic
    ...
    :C?:pnigs::pings
    :C?:pgins::pings
    :C?:opint::point      ; ex: breakpoint, powerpoint, checkpoint, midpoint, logpoint, watchpoint, catchpoint
    :C?:opitn::point
    :C?:opints::points
    :C?:opitns::points
    ...
    :C?:setn::sent        ; ex: absent, consent, represent, present, resent, unsent
    ...
    :C?:teyl::tely        ; ex: immediately, remotely, completely, approximately, proportionately, accurately
    ...
    :C?:ityf::tify
    :C?:tiyf::tify
    :C?:itme::time        ; ex: lifetime, realtime, uptime, downtime, runtime, anytime, comptime
    :C?:tiem::time
    :C?:imte::time
    :C?:itmes::times
    :C?:tiems::times
    ...
    :C?:ugth::ught        ; ex: bought, caught, thought, taught, ought, uncaught, sought
    :C?:ualr::ular        ; ex: modular, regular, tabular, granular, singular, angular
    :C?:luar::ular
    :C?:ualte::ulate      ; ex: emulate, encapsulate, formulate, manipulate, populate, regulate, simulate
    :C?:ualted::ulated
    :C?:ualtes::ulates
