...
EXPLICIT_TESTS = {
    ...
    'porgramming': 'programming', 'igonre': 'ignore', 'prpeares': 'prepares', 'schedluer': 'scheduler',
    ...
    'reutnred': 'returned', 'wrties': 'writes', 'quetsions': 'questions',
    ...
    'rigiht': 'right', 'refrence': 'reference', 'introuce': 'introduce', 'righit': 'right',
    ...
    'unreigsters': 'unregisters', 'archvier': 'archiver',
    ...
    'percnetile': 'percentile', 'gruops': 'groups', 'deafutled': 'defaulted', 'diminsihed': 'diminished',
    'polymorhpism': 'polymorphism', 'disacrds': 'discards', 'thikcen': 'thicken', 'handhsake': 'handshake',
    'inifnity': 'infinity', 'subsytsems': 'subsystems', 'encyrpts': 'encrypts', 'cyrptography': 'cryptography',
