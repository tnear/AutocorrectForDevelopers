#Requires AutoHotkey v1 ; v1 is supported but it is recommended to upgrade to v2,
...
#If !WinActive("ahk_exe WINWORD.exe") && !WinActive("ahk_exe soffice.exe")
    ...
    :b0:aenous::       ; do not convert to -aneous
    :b0:aetd::         ; do not convert to -ated
    :b0:alble::        ; do not convert to -lable
    :b0:airty::        ; do not convert to -arity
    :b0:athc::         ; do not convert to -atch
    :b0:athces::       ; do not convert to -atches
    :b0:bilties::      ; do not convert to -bilities
    :b0:bilites::      ; do not convert to -bilities
    :b0:bilty::        ; do not convert to -bility
    :b0:blites::       ; do not convert to -bilities
    :b0:blities::      ; do not convert to -bilities
    :b0:blity::        ; do not convert to -bility
    :b0:borad::        ; do not convert to -board
    :b0:caction::      ; do not convert to -cation
    :b0:cactions::     ; do not convert to -cations
    :b0:caion::        ; do not convert to -cation
    :b0:caions::       ; do not convert to -cations
    :b0:denet::        ; do not convert to -dent
    :b0:emnt::         ; do not convert to -ment
    :b0:emnts::        ; do not convert to -ments
    :b0:enyc::         ; do not convert to -ency
    :b0:gaes::         ; do not convert to -ages
    :b0:garphy::       ; do not convert to -graphy
    :b0:getn::         ; do not convert to -gent
    :b0:hcing::        ; do not convert to -ching
    :b0:hsing::        ; do not convert to -shing
    :b0:iarty::        ; do not convert to -arity
    :b0:icla::         ; do not convert to -ical
    :b0:idng::         ; do not convert to -ding
    :b0:ietn::         ; do not convert to -ient
    :b0:ietns::        ; do not convert to -ients
    :b0:iezd::         ; do not convert to -ized
    :b0:igth::         ; do not convert to -ight
    :b0:iicent::       ; do not convert to -icient
    :b0:iison::        ; do not convert to -ision
    :b0:iisons::       ; do not convert to -isions
    :b0:iivty::        ; do not convert to -ivity
    :b0:ianl::         ; do not convert to -inal
    :b0:ienet::        ; do not convert to -ient
    :b0:ienets::       ; do not convert to -ients
    :b0:inat::         ; do not convert to -iant
    :b0:itfy::         ; do not convert to -tify
    :b0:ioanl::        ; do not convert to -ional
    :b0:iont::         ; do not convert to -oint
    :b0:ionts::        ; do not convert to -oints
    :b0:iosu::         ; do not convert to -ious
    :b0:iotn::         ; do not convert to -tion
    :b0:iotns::        ; do not convert to -tions
    :b0:itme::         ; do not convert to -time or -items
    :b0:itmes::        ; do not convert to -times or -items
    :b0:itng::         ; do not convert to -ting
    :b0:iton::         ; do not convert to -tion
    :b0:itons::        ; do not convert to -tions
    :b0:ivley::        ; do not convert to -ively
    :b0:iviyt::        ; do not convert to -ivity
    :b0:kaes::         ; do not convert to -akes
    :b0:liity::        ; do not convert to -ility
    :b0:liyt::         ; do not convert to -lity
    :b0:ltiy::         ; do not convert to -lity
    :b0:maeg::         ; do not convert to -mage
    :b0:maion::        ; do not convert to -mation
    :b0:maions::       ; do not convert to -mations
    :b0:meents::       ; do not convert to -ments
    :b0:menet::        ; do not convert to -ment
    :b0:menets::       ; do not convert to -ments
    :b0:metn::         ; do not convert to -ment
    :b0:metns::        ; do not convert to -ments
    :b0:mnets::        ; do not convert to -ments
    :b0:mzie::         ; do not convert to -mize
    :b0:mzied::        ; do not convert to -mized
    :b0:mzies::        ; do not convert to -mizes
    :b0:naet::         ; do not convert to -nate
    :b0:naets::        ; do not convert to -nates
    :b0:necy::         ; do not convert to -ency
    :b0:nig::          ; do not convert to -ing
    :b0:nigs::         ; do not convert to -ings
    :b0:ntaes::        ; do not convert to -nates
    :b0:ntiy::         ; do not convert to -nity
    :b0:oeus::         ; do not convert to -eous
    :b0:ofrm::         ; do not convert to -form
    :b0:ofrms::        ; do not convert to -forms
    :b0:oinal::        ; do not convert to -ional
    :b0:oinally::      ; do not convert to -ionally
    :b0:oitn::         ; do not convert to -oint
    :b0:oitns::        ; do not convert to -oints
    :b0:oius::         ; do not convert to -ious
    :b0:onit::         ; do not convert to -oint
    :b0:onits::        ; do not convert to -oints
    :b0:prot::         ; do not convert to -port
    :b0:prots::        ; do not convert to -ports
    :b0:rnat::         ; do not convert to -rant
    :b0:rtiy::         ; do not convert to -rity
    :b0:oisn::         ; do not convert to -sion
    :b0:oisns::        ; do not convert to -sions
    :b0:oudn::         ; do not convert to -ound
    :b0:oudns::        ; do not convert to -ounds
    :b0:outn::         ; do not convert to -ount
    :b0:outns::        ; do not convert to -ounts
    :b0:raeg::         ; do not convert to -rage
    :b0:rvoe::         ; do not convert to -rove
    :b0:rvoes::        ; do not convert to -roves
    :b0:saeg::         ; do not convert to -sage
    :b0:sehd::         ; do not convert to -shed
    :b0:soin::         ; do not convert to -sion
    :b0:soins::        ; do not convert to -sions
    :b0:stiy::         ; do not convert to -sity
    :b0:svie::         ; do not convert to -sive
    :b0:taed::         ; do not convert to -ated
    :b0:taeg::         ; do not convert to -tage
    :b0:taion::        ; do not convert to -ation
    :b0:taions::       ; do not convert to -ations
    :b0:taive::        ; do not convert to -ative
    :b0:taoin::        ; do not convert to -ation
    :b0:taoins::       ; do not convert to -ations
    :b0:tatn::         ; do not convert to -tant
    :b0:tatns::        ; do not convert to -tants
    :b0:tehr::         ; do not convert to -ther
    :b0:tenet::        ; do not convert to -tent
    :b0:thces::        ; do not convert to -tches
    :b0:tiing::        ; do not convert to -iting
    :b0:tiion::        ; do not convert to -ition
    :b0:tiioning::     ; do not convert to -itioning
    :b0:tiions::       ; do not convert to -itions
    :b0:tiive::        ; do not convert to -itive
    :b0:tiives::       ; do not convert to -itives
    :b0:tiosn::        ; do not convert to -tions
    :b0:tnat::         ; do not convert to -tant
    :b0:tnats::        ; do not convert to -tants
    :b0:tnation::      ; do not convert to -ntation
    :b0:tnations::     ; do not convert to -ntations
    :b0:toin::         ; do not convert to -tion
    :b0:toins::        ; do not convert to -tions
    :b0:tuer::         ; do not convert to -ture
    :b0:tuers::        ; do not convert to -tures
    :b0:tues::         ; do not convert to -utes
    :b0:tuion::        ; do not convert to -ution
    :b0:tuions::       ; do not convert to -utions
    :b0:tvie::         ; do not convert to -tive
    :b0:ullly::        ; do not convert to -ully
    :b0:ulyl::         ; do not convert to -ully
    :b0:utls::         ; do not convert to -ults
    :b0:vtiy::         ; do not convert to -vity
    :b0:wrae::         ; do not convert to -ware
    {
    }
